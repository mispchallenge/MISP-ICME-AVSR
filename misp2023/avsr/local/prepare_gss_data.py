...
def read_textgrid_from_file(filepath):
    ...
    ,"R61_S360361362363_C03_I1_Near_360.TextGrid","R61_S360361362363_C03_I1_Near_361.TextGrid","R61_S360361362363_C03_I1_Near_362.TextGrid","R61_S360361362363_C03_I1_Near_363.TextGrid","R15_S230231232_C09_I1_Near_230.TextGrid","R15_S230231232_C09_I1_Near_231.TextGrid","R15_S230231232_C09_I1_Near_232.TextGrid"]
...
def read_tier_from_lines(tier_lines,filepath):
    ...
    assert len(tier_lines[5:]) == intervals_num * 5,print(filepath)
    # 'error lines'
...
def prepare_channels_scp(data_root, store_dir, set_type='train'):#set_type train dev eval  sub_dir:far mid near
    ...
    wav_path_list = list(set([ path[:-6] for path in wav_path_list]))
...
def prepare_segments_text_utt2spk_worker(transcription_dir, set_type, store_dir, processing_id=None, processing_num=None,pos="far",without_wav=False):
    segments_lines = []
    text_sentence_lines = []
    utt2spk_lines = []
    tier_name = '内容层'
        ...
        if processing_token:
            ...
            for speaker in speaker_list:
                tg = read_textgrid_from_file(filepath=os.path.join(
                    transcription_dir, '{}_{}_{}_{}_Near_{}.TextGrid'.format(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--channel_dir', type=str, default=None, help='directory of original nutiple channel waveform')
    parser.add_argument('--without_wav', type=bool, default=False, help='don not prepare wav.scp')
    parser.add_argument('--without_mp4', type=bool, default=False, help='don not prepare mp4.scp')
