...
if __name__ == '__main__':
    ...
    parser.add_argument( "--pt_dir",type=str,default="avsrfeature/misp2021_avsr/eval_far_video_lip_segment/pt",
    help="the path where roi.pt files stored",)
    parser.add_argument( "--tgtdir", type=str, default="avsrdump/raw/org/eval_mid_lip", help="the path where roi.scp storened")
