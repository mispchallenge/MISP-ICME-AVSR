...
# encoder_out = torch.rand(9,52,256)
# ys_pad = torch.randint(0,4000,(9,3))
# encoder_out_lens = torch.randint(52,53,(9,))
# ys_pad_lens = torch.randint(2,3,(9,))
# ctc = CTC(odim=4000, encoder_output_sizse=256, **get_default_kwargs(CTC))
